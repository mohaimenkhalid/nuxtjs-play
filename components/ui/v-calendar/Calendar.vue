...
.calendar .vc-weekday {
  @apply text-secondary rounded-md font-normal text-[0.8rem];
}
.calendar .vc-weeks {
...
.calendar .vc-day-content  {
  @apply text-center text-sm p-0 relative focus-within:relative focus-within:z-20 inline-flex items-center justify-center hover:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 hover:bg-secondary hover:text-secondary-light h-9 w-9 font-normal aria-selected:opacity-100 select-none;
}
...
.calendar .vc-highlight-content-solid, .calendar .vc-highlight-content-outline {
  @apply bg-primary text-secondary hover:bg-primary hover:text-secondary focus:bg-primary focus:text-secondary;
}
.calendar .vc-highlight-content-light {
  @apply bg-secondary text-secondary-light;
}
...
.vc-time-select-group {
  @apply inline-flex items-center px-1 rounded-md bg-primary border border-solid border-secondary;
}
.vc-time-select-group .vc-base-icon {
  @apply mr-1 text-primary stroke-primary;
}
.vc-time-select-group select {
  @apply bg-primary p-1 appearance-none outline-none text-center;
}
.vc-time-weekday {
  @apply text-secondary tracking-wide;
}
.vc-time-month {
